...
# Windows platforms
  ...
  set(IPOPT_DIR $ENV{IPOPT_DIR} CACHE PATH "Path to IPOPT build directory")
    ...
    find_library(IPOPT_IPOPT_LIBRARY_RELEASE
         NAMES libipopt ipopt ipopt-3
         PATHS ${IPOPT_DIR}/lib
           ${IPOPT_DIR}/lib/coin
         NO_DEFAULT_PATH)
    find_library(IPOPT_IPOPT_LIBRARY_DEBUG
         NAMES libipoptD ipoptD ipoptd
         PATHS ${IPOPT_DIR}/lib
           ${IPOPT_DIR}/lib/coin
         NO_DEFAULT_PATH)

  select_library_configurations(IPOPT_IPOPT)
  if(NOT IPOPT_IPOPT_LIBRARY)
    if(IPOPT_IPOPT_LIBRARY_RELEASE)
      set(IPOPT_IPOPT_LIBRARY ${IPOPT_IPOPT_LIBRARY_RELEASE})
    elseif(IPOPT_IPOPT_LIBRARY_DEBUG)
      set(IPOPT_IPOPT_LIBRARY ${IPOPT_IPOPT_LIBRARY_DEBUG})
    endif()
  endif()
